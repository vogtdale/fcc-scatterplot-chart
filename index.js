...
const BarChart = ({ data }) => {
  ...
  const createBarChart = () => {
    ...
    //change format to display yaxis to display time
    data.forEach(function (d) {
      d.Place = +d.Place;
      var parsedTime = d.Time.split(":");
      d.Time = new Date(Date.UTC(1978, 0, 1, 0, parsedTime[0], parsedTime[1]));
    });
